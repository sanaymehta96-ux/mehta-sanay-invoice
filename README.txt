MEHTA SANAY INVOICE v41
=======================

v41 is an installable offline-first PWA based on the working v40 invoice.
The invoice layout/engine is preserved; v41 adds PWA installation and Google Drive sync.
...
- PDFs are NOT uploaded automatically in v41; PDF generation remains local.

IMPORTANT
---------
Keep invoice_editor_v40.html as the frozen fallback/master.
If anything behaves unexpectedly in v41, use v40 immediately and report the exact issue.
